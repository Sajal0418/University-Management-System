...
// Builder class to construct EnterMarks objects
class EnterMarksBuilder {
    private EnterMarks enterMarks;

    // Constructor to initialize the EnterMarks object
    public EnterMarksBuilder() {
        enterMarks = new EnterMarks();
    }

    // Method to set the Choice for roll number
    public EnterMarksBuilder setRollNoChoice(Choice choice) {
        enterMarks.crollno = choice;
        return this;
    }

    // Method to set the JComboBox for semester
    public EnterMarksBuilder setSemesterComboBox(JComboBox comboBox) {
        enterMarks.cbsemester = comboBox;
        return this;
    }

    // Method to set the JTextField for subject 1
    public EnterMarksBuilder setSubject1TextField(JTextField textField) {
        enterMarks.tfsub1 = textField;
        return this;
    }

    // Similarly, add methods for setting other components as needed

    // Method to build the EnterMarks object
    public EnterMarks build() {
        return enterMarks;
    }
}
...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        // Creating an instance of EnterMarks using the builder
        EnterMarks enterMarks = new EnterMarksBuilder()
